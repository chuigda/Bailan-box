...
还是要感谢南科大的老师，早在六年前招生的时候就预见了我现在没有数理基础，做不了嗑盐，只能混吃等死的结局，然后把我拒了。否则我现在肯定被同学碾的渣也不剩，看着别人一作顶会闭着眼睛投，躺拿四大 offer，而自己在实验室里啥也干不了，最后被迫退远退学，年年补考，连毕业都困难，成为失败中最失败的那一种废物。
想被大佬吊打，打醒我废物的一生
我觉得我的失败是命中注定`

const TrashBin = () => (
  <div style={{ height: 'calc(100% - 8px)', padding: '4px' }}>
    <TextArea style={{ width: '100%', height: '100%' }} value={howVagatableIAm} readOnly />
  </div>
)
